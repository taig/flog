...
object implicits {
  implicit private val encoderMethod: Encoder[Method] = Encoder[String].contramap(_.show)

  implicit private val encoderUri: Encoder[Uri] = Encoder[String].contramap(_.show)

  implicit private val encoderHeaders: Encoder[Headers] =
