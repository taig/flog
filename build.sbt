...
val Version = new {
  ...
  val Circe = "0.13.0"
  val Fs2 = "2.5.3"
  val GoogleApiServicesLogging = "v2-rev20210217-1.31.0"
  val GoogleApiServicesSheets = "v4-rev20210223-1.31.0"
  val GoogleAuthLibraryOauth2Http = "0.24.1"
  val GoogleCloudLogging = "2.1.5"
  val Http4s = "0.21.20"
  val Monix = "3.3.0"
  val Munit = "0.7.22"
